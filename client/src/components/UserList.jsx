...
export default function UserList() {
  ...
  return (
    <div className='2xl:w-[417px] 1xl:w-[417px] xl:w-[417px] 1lg:w-80 lg:w-80 1md:w-64 md:w-64 sm:w-full xs:w-full flex flex-col'>
      {userdata && userdata.users.map((value)=>(
       ...
       className={`${value.username.includes(`${searchquery}`) || value.email.includes(`${searchquery}`) ?'order-first': 'bg-transparent' }`}>
          ...
          to={`message`} >
            ...
            <div className='flex'>
              <div className='w-20 '>
                 <div className=' 2xl:w-14 1xl:w-14 xl:w-14 1lg:w-14 lg:w-12 1md:w-12 md:w-12 sm:w-14 xs:w-12
                                  2xl:h-14 1xl:h-14 xl:h-14 1lg:h-14 lg:h-12 1md:h-12 md:h-12 sm:h-14 xs:h-12
              ...
              <div>
                <div>
                  <h1 className=' 2xl:w-64 1xl:w-64 xl:w-56 1lg:w-48 lg:w-36 1md:w-36 md:w-28 sm:w-96 xs:w-72   overflow-hidden truncate '><span className=' font-bold'>{value.username}</span></h1>
                </div>
                <div>
                  <p className=' 2xl:w-64 1xl:w-64 xl:w-56 1lg:w-48 lg:w-36 1md:w-36 md:w-28  sm:w-96 xs:w-72  overflow-hidden truncate '>{value.email}</p>
                </div>
              </div>
            </div>
          </div>
